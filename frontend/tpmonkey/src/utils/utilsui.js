...
function Toast(msg, duration){  
    ...
    m.innerHTML = msg;  
    m.style.cssText="font-size: 14px;color: rgb(255, 255, 255);background-color: rgba(0, 0, 0, 0.6);padding: 10px 15px;margin: 0 0 0 -60px;border-radius: 4px;position: fixed;    top: 50%;left: 50%;width: 430px;text-align: center;";
